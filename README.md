...
it is used to match the url with the proper route path
1. How would you explain form validation to someone who has never programmed before?
it is meant to ensure that all required inputs are done correctly before allowing to submit so the backend doesnt receive bad data
1. In 1-2 sentences, define end to end testing.
it is a process of testing all functionality on the users end from start to finish
